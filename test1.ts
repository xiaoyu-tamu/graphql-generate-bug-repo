...
export type HeroAppearsInQuery = { __typename?: 'Query', hero?: Maybe<{ __typename?: 'Human', name: string, appearsIn: Array<Maybe<Episode>> } | { __typename?: 'Droid', name: string, appearsIn: Array<Maybe<Episode>> }> };
...
export type HeroDetailsWithFragmentQuery = { __typename?: 'Query', hero?: Maybe<(
    { __typename?: 'Human' }
...
export type HumanWithNullHeightQuery = { __typename?: 'Query', human?: Maybe<(
    { __typename?: 'Human' }
    & HumanFieldsFragment
  )> };
