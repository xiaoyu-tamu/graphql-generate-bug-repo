...
import { HumanFieldsFragment } from './HumanFields.graphql';
import gql from 'graphql-tag';
import { HumanFieldsFragmentDoc } from './HumanFields.graphql';
...
export type HumanWithNullHeightQuery = { __typename?: 'Query', human?: Types.Maybe<(
    { __typename?: 'Human' }
    & HumanFieldsFragment
  )> };
 ...
 * });
 */
export function useHumanWithNullHeightQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<HumanWithNullHeightQuery, HumanWithNullHeightQueryVariables>) {
        return ApolloReactHooks.useQuery<HumanWithNullHeightQuery, HumanWithNullHeightQueryVariables>(HumanWithNullHeightDocument, baseOptions);
      }
export function useHumanWithNullHeightLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<HumanWithNullHeightQuery, HumanWithNullHeightQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<HumanWithNullHeightQuery, HumanWithNullHeightQueryVariables>(HumanWithNullHeightDocument, baseOptions);
        }
