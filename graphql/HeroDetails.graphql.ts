...
export type HeroDetailsQuery = { __typename?: 'Query', hero?: Types.Maybe<{ __typename?: 'Human', height?: Types.Maybe<number>, name: string } | { __typename?: 'Droid', primaryFunction?: Types.Maybe<string>, name: string }> };
 ...
 * });
 */
export function useHeroDetailsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<HeroDetailsQuery, HeroDetailsQueryVariables>) {
        return ApolloReactHooks.useQuery<HeroDetailsQuery, HeroDetailsQueryVariables>(HeroDetailsDocument, baseOptions);
      }
export function useHeroDetailsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<HeroDetailsQuery, HeroDetailsQueryVariables>) {
